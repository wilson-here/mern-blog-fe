    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-left">
          ...
          recusandae quo exercitationem sint. Eligendi magnam pariatur totam
          laboriosam eos aspernatur tempore deserunt, non fugit. Quasi atque ad
          deserunt eligendi doloremque.
        </p>
        ...
        <div className="mt-4 flex flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
